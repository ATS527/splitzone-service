package com.splitzone.service.shared.exception

import com.splitzone.service.shared.exception.filter.RequestIdFilter
import com.splitzone.service.shared.exception.handler.GlobalExceptionHandler
import com.splitzone.service.shared.exception.types.ResourceNotFoundException
...
class GlobalExceptionHandlerTest {
    ...
    fun setUp() {
        mockMvc = MockMvcBuilders.standaloneSetup(TestController())
            ...
            .addFilters<StandaloneMockMvcBuilder>(RequestIdFilter())
            .build()
    }
